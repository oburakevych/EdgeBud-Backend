...
import com.edgebud.business.company.CompanyIntegrationTest;
...
privileged aspect CompanyIntegrationTest_Roo_IntegrationTest {
    ...
    public void CompanyIntegrationTest.testFindCompany() {
        ...
        Assert.assertEquals("Find method for 'Company' returned the incorrect identifier", id, obj.getId_());
    }
    ...
    public void CompanyIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Company' identifier to be null", obj.getId_());
        obj.persist();
        obj.flush();
        Assert.assertNotNull("Expected 'Company' identifier to no longer be null", obj.getId_());
    }
